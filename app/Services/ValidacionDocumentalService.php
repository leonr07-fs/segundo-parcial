...
use App\Models\ValidacionDocumental;
...
class ValidacionDocumentalService
{
     ...
     * @return ValidacionDocumental
     * @throws \DomainException
     */
    public function validarDocumentos(int $inscripcionId, array $revisiones, Request $request): ValidacionDocumental
    {
