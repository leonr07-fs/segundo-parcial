            ...
            <div class="space-y-6">
                <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-2 text-sm leading-6 text-gray-500">
                        La sesión fue creada correctamente y el sistema ya conoce el alcance de tu carga docente.
                    </p>
                    <div class="mt-6 grid gap-3 sm:grid-cols-3">
                        ...
                        <div class="rounded-xl border border-gray-100 bg-gray-50 p-4">
                            <p class="text-sm font-bold text-gray-900">Materias Habilitadas</p>
                            <p class="mt-1 text-xs text-gray-500 font-medium">Computación / Matemáticas / Física / Inglés</p>
                        </div>
                    </div>
                </div>

                <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                    <h3 class="text-lg font-bold text-blue-950 mb-4">Carga Horaria y Grupos Asignados</h3>
                    <div class="text-sm text-gray-500 py-8 text-center bg-slate-50 rounded-xl border border-dashed border-slate-200">
                        No hay grupos asignados para la gestión actual o el módulo se encuentra en fase de planeación.
                    </div>
                </div>
            </div>
        </div>
